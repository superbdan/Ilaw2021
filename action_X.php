			...
			foreach($result as $row) {
				...
				echo '
					<div class="row">
						...
						<div class="col-md-3"><img class="img-responsive" src="admin/product_images/'.$product_img1.'" /></div>
						<div class="col-md-3">'.$items_name.'</div>
						<div class="col-md-3">'.CURRENCY.''.$items_price.'</div>
					</div>';
				...
				foreach($result as $row){
					...
					echo 
						'<div class="row">
								<div class="col-md-2">
									<div class="btn-group">
										<a href="#" remove_id="'.$items_id.'" class="btn btn-danger remove"><span class="glyphicon glyphicon-trash"></span></a>
										<a href="#" update_id="'.$items_id.'" class="btn btn-primary update"><span class="glyphicon glyphicon-ok-sign"></span></a>
									</div>
								</div>
								<input type="hidden" name="product_id[]" value="'.$items_id.'"/>
								<input type="hidden" name="" value="'.$cart_item_id.'"/>
								<div class="col-md-2"><img class="img-responsive" src="admin/product_images/'.$product_img1.'"></div>
								<div class="col-md-2">'.$items_name.'</div>
								<div class="col-md-2"><input type="text" class="form-control qty" value="'.$qty.'" ></div>
								<div class="col-md-2"><input type="text" class="form-control price" value="'.$items_price.'" readonly="readonly"></div>
								<div class="col-md-2"><input type="text" class="form-control total" value="'.$items_price.'" readonly="readonly"></div>
							</div>';
				}
