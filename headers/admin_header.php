<header class="ilaw_header">
        ...
        <ul id ="menuList" >
            ...
            <div class="dropdown">
                <a class = "cart_btn"><i class="fas fa-shopping-cart fa-2x"></i><span class="badge"></span></a>
                ...
                <a class = "logout_btn" type="button" href="logout.php" >
                    <span class="logout_text"> Logout </span>
                    <span class="logout_icon"><i class="fas fa-sign-out-alt"></i></span>
                </a>
