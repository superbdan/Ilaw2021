            ...
            <ul class="nav ml-auto add_product">
                ...
                <li>
                    <div class="row" align="right">
                        <button type="button" name="add" id="add_button" data-toggle="modal" data-target="#customerModal" class="btn btn-info mt-1 ml-4 mr-3 p-1"><i class="fa fa-plus-square"></i> Add New Order</button>
                    </div>
                </li>
            </ul>
        </ol>
