            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <ul class="nav ml-auto add_product">
                        <li><a type="button" id="printButton" class="print_table btn btn-secondary p-2" data-toggle="tooltip" data-placement="bottom" title="Print Table"><i class="fa fa-print fa-lg"></i></a></li>
                    </ul>
                </ol>
            </nav>
			...
			<div style="clear:both"></div>
                    ...
                    <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">
                        <div class="table-responsive">
							...
							<thead>
								<tr>
									<th class="print_border text-center">Supplier Name</th>
									<th class="print_border text-center">Contact No.</th>
							...
							<tfoot>
								<tr>
									<th class="print_none text-center">Supplier Name</th>
									<th class="print_none text-center">Contact No.</th>
