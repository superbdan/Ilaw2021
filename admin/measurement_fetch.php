...
foreach($result as $row)
{
	...
	$sub_array[] = '<center><button type="button" name="update" id="'.$row["measurement_id"].'" class="btn btn-primary btn-xs update " data-toggle="tooltip" data-placement="bottom" title="Edit Measurement" "><i class="fa fa-pencil"></i></button></center>';
$data[] = $sub_array;
}
