            ...
            <div class="col-sm-3 col-xs-6 sidebar pl-0">
                <div class="inner-sidebar mr-2">
                    ...
                    <div class="avatar text-center">
                        <img src="images/Profiles/Patrick.jpg" alt="Admin_Profile" class="rounded-circle" />
                        <p><strong>Mark Deofat Baluran</strong></p>
        ...
        <ul class="sidebar-menu mt-4 mb-4">
            ...
            <?php  } ?>
             ...
             <?php 
                    ...
                    ?>
                    <li class="parent">
                        <a href="reports.php"  class="active"><i class=" fa fa-file-text mr-3"> </i>
                        <span class="none">Reports</span>
                        </a>
                    </li>
                    <?php }else{ ?>
                    <li class="parent">
                        <a href="reports.php"><i class="fa fa-file-text mr-3"> </i>
                        <span class="none">Reports</span>
                    </a>
            </li>
            <?php  } ?>
