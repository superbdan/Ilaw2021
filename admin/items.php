                    ...
                    <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">
                        <div class="table-responsive">
                            <table id="items_data" class="table table-bordered table-hover w-100 table-sm display nowrap">
								<thead>
									<tr>
									<th class="print_border text-center">Item Name</th>
									<th class="print_border text-center">Category</th>
									<th class="print_border text-center">Cost</th>
									<th class="print_border text-center">Price</th>
									<th class="print_border text-center">In-hold</th>
									<th class="print_border text-center">Supplier</th>
									<th class="print_border text-center">Unit</th>
								...
								<tfoot>
									<tr>
									<th class="print_none text-center">Item Name</th>
									<th class="print_none text-center">Category</th>
									<th class="print_none text-center">Cost</th>
									<th class="print_none text-center">Price</th>
									<th class="print_none text-center">In-hold</th>
									<th class="print_none text-center">Supplier</th>
									<th class="print_none text-center">Unit</th>
